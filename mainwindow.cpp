    ...
    , ui(new Ui::MainWindow)
{
    ...
    display = new DisplayPortView(this);
    display->show();

    series = new QSplineSeries(this);
    series->setName("Signal Output");

    QObject::connect(this, &MainWindow::signal_paint_chart, display, &DisplayPortView::recieve_paint_graph);
    QObject::connect(this, &MainWindow::signal_add_value, display, &DisplayPortView::recieve_add_value);
    QObject::connect(this, &MainWindow::signal_clear_value, display, &DisplayPortView::recieve_clear_value);
    QObject::connect(display, &DisplayPortView::signal_shutdown, this, &MainWindow::recieve_shutdown);
}
...
void MainWindow::on_pb_start_clicked()
{
    ...
    auto findMax = [&](QVector<double> res){
                                                ...
                                                paint_chart(series, mins.first(), maxs.first());
...
void MainWindow::recieve_shutdown()
{
    this->close();
}

void MainWindow::paint_chart(QSplineSeries * data, double min, double max)
{
    emit signal_paint_chart(data, min, max);
}

void MainWindow::add_value(double x, double y)
{
    emit signal_add_value(x, y);
}

void MainWindow::clear_value(QSplineSeries * data)
{
    emit signal_clear_value(data);
}
